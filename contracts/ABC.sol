...
contract Token {
    ...
    */
    ...
    /// @param _issueQty The quantity of new tokens to be issued
    /// @return Whether the issuing was successfull or not
    function issueNew( uint256 _issueQty ) public returns (bool success);

    /// @param _vanishQty The quantity of new tokens to be burned
    /// @return Whether the vanishing was successfull or not
    function vanishToken( uint256 _vanishQty ) public returns (bool success);

    /// @param _target The address to be freezed
    /// @param _freeze A boolean 1-frozen 0-not frozen
    /// @return Whether the freezing account was successful or not
...
contract ABC is Token {
    ...
    */
    ...
    string public version = 'ABCv0.1';       //human 0.1 standard. Just an arbitrary versioning scheme.
